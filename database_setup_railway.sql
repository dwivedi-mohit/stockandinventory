-- Inventory Management System - Railway Schema Setup
-- Runs inside the existing Railway MySQL database (no DROP/CREATE DATABASE).
-- Usage: railway connect MySQL < database_setup_railway.sql
--    or: mysql -h <host> -P <port> -u <user> -p<pass> <db> < database_setup_railway.sql
